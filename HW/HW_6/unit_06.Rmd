...
```
```{r create tsibble}
flights$time_index <- as_datetime(1511870400)
year(flights$time_index)<-flights$year
...
weather$time_index <- as_datetime(1511870400)
year(weather$time_index)<-weather$year
month(weather$time_index)<-weather$month
day(weather$time_index)<-weather$day
hour(weather$time_index)<-weather$hour
...
# hourly_acf <- weather_ts %>%filter(origin == "JFK") %>% ACF(temp, na.action = "na.pass")
...
plot1_acf <- dataset_1 %>% as_tsibble() %>% ACF(y) %>% autoplot()
plot1_pcf <- dataset_1 %>% as_tsibble() %>% ACF(y, type = c("partial")) %>% autoplot()
...
plot2_acf <- dataset_2 %>% as_tsibble() %>% ACF(y) %>% autoplot()
plot2_pcf <- dataset_2 %>% as_tsibble() %>% ACF(y, type = c("partial")) %>% autoplot()
...
plot3_acf <- dataset_3 %>% as_tsibble() %>% ACF(y) %>% autoplot()
plot3_pcf <- dataset_3 %>% as_tsibble() %>% ACF(y, type = c("partial")) %>% autoplot()
...
plot4_acf <- dataset_4 %>% as_tsibble() %>% ACF(y) %>% autoplot()
plot4_pcf <- dataset_4 %>% as_tsibble() %>% ACF(y, type = c("partial")) %>% autoplot()
...
plot5_acf <- dataset_5 %>% as_tsibble() %>% ACF(y) %>% autoplot()
plot5_pcf <- dataset_5 %>% as_tsibble() %>% ACF(y, type = c("partial")) %>% autoplot()
...
unemployment$time_index <- ym(paste(unemployment$year, unemployment$month))
```
